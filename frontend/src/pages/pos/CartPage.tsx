                      ...
                      <td className="px-4 py-0.5 text-center w-0 text-nowrap">
                        <div className={`flex w-full items-center justify-end ${loading ? "animate-pulse" : ""}`}>
                          ...
                          {item.status != OrderItemStatus.Cancelled && (
                            <Button title="Cancel" className={`bg-red-600 rounded-lg rounded-xl  h-5 aspect-square flex items-center justify-center hover:opacity-50  text-white !px-0`} onClick={() => onCancelItem(item)} ask>
