...
const paperClassName =
  "max-w-[400px] bg-white rounded-lg group-open/dialog:opacity-100  group-open/dialog:scale-100 group-open/dialog:translate-y-0 opacity-0  transition-all flex-1  h-min translate-y-6";
