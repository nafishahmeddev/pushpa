...
export function MainNav({ items }: MainNavProps) {
  ...
  return (
    <>
      <ul
        className={`flex-1 flex h-full items-stretch md:justify-end fixed top-0 w-[300px] bg-white z-50 md:z-0 flex-col transition-all border-e md:border-e-0 md:w-auto md:static md:bg-transparent md:flex-row md:opacity-100 ${menu.open ? "left-0 opacity-100" : "-left-[300px] opacity-60"}`}
      >
