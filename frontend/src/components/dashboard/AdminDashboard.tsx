  ...
  return (
    <div className="grid grid-rows-[auto_1fr] gap-6 p-4 h-full">
      ...
      <div className="bg-white inline-flex w-min rounded-xl border overflow-hidden p-0.5 h-10">
        {Object.values(TimeFrame).map((value) => (
          <button
            ...
            className={`px-4 py-1.5 rounded-xl text-sm text-nowrap flex flex-nowrap items-center gap-2 ${timeFrame == value ? "bg-indigo-300/40 text-indigo-900" : "text-gray-600"}`}
          >
      ...
      {isLoading && (
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div className="border bg-white rounded-xl h-60 flex flex-col gap-2 w-full row-span-2 py-6 dash-card shimmer" />
            <div className="border bg-white rounded-xl h-28 p-5 flex flex-col gap-2 w-full dash-card shimmer" />
            <div className="border bg-white rounded-xl h-28 p-5 flex flex-col gap-2 w-full dash-card shimmer" />
            <div className="border bg-white rounded-xl h-28 p-5 flex flex-col gap-2 w-full dash-card shimmer" />
            <div className="border bg-white rounded-xl h-28 p-5 flex flex-col gap-2 w-full dash-card shimmer" />
            <div className="border bg-white rounded-xl h-28 p-5 flex flex-col gap-2 w-full dash-card shimmer" />
      ...
      {!isLoading && !error && result && (
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div className="border bg-white rounded-xl h-60 flex flex-col gap-2 w-full row-span-2 py-6 pb-0  dash-card">
            ...
            <div className="border bg-white rounded-xl h-28 p-5 flex flex-col gap-2 w-full dash-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5 mb-5">
            <div className="border bg-white rounded-xl  flex flex-col gap-2 w-full row-span-2 py-6 pb-0  dash-card">
