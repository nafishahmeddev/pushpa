...
export default function Button({
  ...
  return (
    <button
      {...props}
      className={`flex text-nowrap gap-2 h-10 px-5 hover:opacity-60 disabled:opacity-60 rounded-xl overflow-hidden relative items-center justify-center font-semibold ${props.className ?? ""}`}
    >
       {loading && (
